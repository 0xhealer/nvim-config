...
map({
	...
	},
	{
		...
		desc = "Run Codelens",
		mode = "n", -- normal-mode only (visual-mode <leader>cb is copy-as-codeblock, core/keymaps.lua)
	},
...
-- Bufferline — ]b/[b for cycling since <tab>/<s-tab> already navigate real
-- Vim tab-pages (core/keymaps.lua) and <leader>bd already means "delete
-- hidden buffers" (also core/keymaps.lua) — kept separate rather than
